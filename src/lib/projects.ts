...
const goldenLuxuria: Project = {
  ...
  status: "Completed",
  images: [
    { src: "golden-luxuria/Main_Entrance_Gate_Day_Perspective.webp" },
    { src: "golden-luxuria/Building_Full_Front_Elevation_Golden_Hour.webp" },
    { src: "golden-luxuria/Interior_Entrance_Lobby_Reception.webp" },
    { src: "golden-luxuria/Residential_Complex_Birdview_Aerial.webp" },
  ],
  detail: {
    hero: {
      image: { src: "golden-luxuria/Building_Full_Front_Elevation_Golden_Hour.webp" },
    ...
    firstLook: {
      headline: "First Look",
      items: [
        { src: "golden-luxuria/Main_Entrance_Gate_Day_Perspective.webp", caption: "Main Entrance" },
        { src: "golden-luxuria/Building_Full_Front_Elevation_Golden_Hour.webp", caption: "Front Elevation" },
      ],
    },
    intro: {
    ...
    summary: {
      cards: [
        { src: "golden-luxuria/Main_Entrance_Gate_Day_Perspective.webp", metric: "Tavra, Bharuch", label: "Location" },
        { src: "golden-luxuria/Building_Full_Front_Elevation_Golden_Hour.webp", metric: "676 - 959 Sq.Ft.", label: "Carpet" },
        { src: "golden-luxuria/Interior_Entrance_Lobby_Reception.webp", metric: "2 & 3 BHK", label: "Type" },
        { src: "golden-luxuria/Residential_Complex_Birdview_Aerial.webp", metric: "5 Blocks", label: "A, B, C, D & E" },
      ],
    },
    highlights: {
      headline: "Visual Highlights",
      items: [
        { src: "golden-luxuria/Interior_Entrance_Lobby_Reception.webp", caption: "Grand entrance lobby" },
        { src: "golden-luxuria/Interior_Banquet_Hall_Formal_Setup.webp", caption: "Private banquet hall" },
        { src: "golden-luxuria/Landscape_Zen_Garden_Buddha_Statue.webp", caption: "Zen garden & meditation spaces" },
        { src: "golden-luxuria/Residential_Complex_Birdview_Aerial.webp", caption: "2 BHK & 3 BHK residences" },
      ],
    },
    amenities: {
      ...
      feature: { src: "golden-luxuria/Landscape_Garden_Walking_Track.webp" },
      items: [
        { key: "walking-track", label: "Walking Track" },
    ...
    gallery: {
      ...
      images: [
        { src: "golden-luxuria/Building_Front_Elevation_Courtyard_View.webp" },
        { src: "golden-luxuria/Building_Side_Elevation_Daylight.webp" },
        { src: "golden-luxuria/Children_Play_Area_Community_Park.webp" },
        { src: "golden-luxuria/Interior_Fitness_Gym_Amenities.webp" },
        { src: "golden-luxuria/Interior_Recreation_Indoor_Games_Room.webp" },
        { src: "golden-luxuria/Landscape_Garden_Walking_Track.webp" },
        { src: "golden-luxuria/Landscape_Zen_Garden_Buddha_Statue.webp" },
        { src: "golden-luxuria/Interior_Entrance_Lobby_Reception.webp" },
      ],
    },
    location: {
...
const goldenHeaven: Project = {
  ...
  status: "Completed",
  images: [
    { src: "golden-heaven/Main_Entrance_Gate_Day_View.webp" },
    { src: "golden-heaven/Building_Front_Perspective_Daylight.webp" },
    { src: "golden-heaven/Building_Full_Elevation_Twilight.webp" },
    { src: "golden-heaven/Residential_Complex_Birdview_Aerial.webp" },
  ],
  detail: {
    hero: {
      image: { src: "golden-heaven/Building_Front_Perspective_Daylight.webp" },
    ...
    firstLook: {
      headline: "First Look",
      items: [
        { src: "golden-heaven/Main_Entrance_Gate_Day_View.webp", caption: "Main Entrance" },
        { src: "golden-heaven/Building_Front_Perspective_Daylight.webp", caption: "Front Elevation" },
      ],
    },
    intro: {
    ...
    summary: {
      cards: [
        { src: "golden-heaven/Main_Entrance_Gate_Day_View.webp", metric: "Uttran, Surat", label: "Location" },
        { src: "golden-heaven/Building_Front_Perspective_Daylight.webp", metric: "1381 - 1943 Sq.Ft.", label: "Carpet" },
        { src: "golden-heaven/Building_Full_Elevation_Twilight.webp", metric: "3 & 4 BHK", label: "Type" },
        { src: "golden-heaven/Residential_Complex_Birdview_Aerial.webp", metric: "3 Buildings", label: "A, B & C" },
      ],
    },
    highlights: {
      headline: "Visual Highlights",
      items: [
        { src: "golden-heaven/Building_Full_Elevation_Twilight.webp", caption: "Modern tower façade" },
        { src: "golden-heaven/Children_Play_Area_Amenities.webp", caption: "Children's play & recreation zone" },
        { src: "golden-heaven/Garden_Landscaping_Lawn_Area.webp", caption: "Landscaped gardens & open lawns" },
        { src: "golden-heaven/Residential_Complex_Birdview_Aerial.webp", caption: "3 BHK & 4 BHK, 3 buildings" },
      ],
    },
    amenities: {
      headline: "Everyday Amenities",
      body: "Spaces that turn a building into a community.",
      feature: { src: "golden-heaven/Garden_Landscaping_Water_Feature.webp" },
          ...
          plans: [
            {
              ...
              image: { src: "golden-heaven/3bhk_floor_plan.png" },
              note: "*Final dimensions may vary on site.",
            },
          ],
        },
          ...
          plans: [
            {
              ...
              image: { src: "golden-heaven/4bhk_floor_plan.png" },
              note: "*Final dimensions may vary on site.",
            },
          ],
        },
    ...
    gallery: {
      ...
      body: "A look at what awaits you.",
      images: [
        { src: "golden-heaven/Children_Play_Area_Aerial.webp" },
        { src: "golden-heaven/Garden_Landscaping_Water_Feature.webp" },
        { src: "golden-heaven/Garden_Seating_Aesthetic_Bench.webp" },
        { src: "golden-heaven/Sunken_Seating_and_Parking.webp" },
...
const goldenNirvana: Project = {
  ...
  status: "Completed",
  images: [
    { src: "golden-nirvana/Building_Low_Angle_Street_View.webp" },
    { src: "golden-nirvana/Exterior_Frontage_Aerial.webp" },
    { src: "golden-nirvana/Community_Park_Aerial_Birdview.webp" },
    { src: "golden-nirvana/Bungalow_Main_Front_Elevation_Perspective.webp" },
  ],
  detail: {
    hero: {
      image: { src: "golden-nirvana/Building_Low_Angle_Street_View.webp" },
      eyebrow: "Township",
    ...
    firstLook: {
      headline: "First Look",
      items: [
        { src: "golden-nirvana/Building_Low_Angle_Street_View.webp", caption: "Main Entrance" },
    ...
    summary: {
      cards: [
        { src: "golden-nirvana/Building_Low_Angle_Street_View.webp", metric: "GIDC, Ankleshwar", label: "Location" },
        { src: "golden-nirvana/Exterior_Frontage_Aerial.webp", metric: "705 - 1334 Sq.Ft.", label: "Carpet" },
        { src: "golden-nirvana/Bungalow_Main_Front_Elevation_Perspective.webp", metric: "2 BHK, Bungalow & Shops", label: "Type" },
        { src: "golden-nirvana/Community_Park_Aerial_Birdview.webp", metric: "5 Blocks", label: "A - E" },
      ],
    },
    highlights: {
      headline: "Visual Highlights",
      items: [
        { src: "golden-nirvana/Exterior_Frontage_Aerial.webp", caption: "2 BHK towers, bungalows & shops" },
        { src: "golden-nirvana/Community_Park_Aerial_Birdview.webp", caption: "Open parks & community gardens" },
        { src: "golden-nirvana/Landscape_Garden_Zen_Seating_Area.webp", caption: "Dedicated leisure & recreational zones" },
          ...
          plans: [
            {
              ...
              image: { src: "golden-nirvana/2bhk_typical_floor_plan_2nd_to_7th_floor_block_abcde.png" },
              note: "*Final dimensions may vary on site.",
            },
          ],
        },
    ...
    gallery: {
      ...
      body: "A look at what awaits you.",
      images: [
        { src: "golden-nirvana/Bungalow_Entrance_Parking_Day.webp" },
        ...
        { src: "golden-nirvana/Community_Park_Ground_Perspective.webp" },
    ...
    masterPlan: {
      ...
      image: { src: "golden-nirvana/master_layout_plan.png" },
    },
    location: {
      headline: "Location",
...
const goldenVilla: Project = {
  ...
  status: "Completed",
  images: [
    { src: "golden-villa/Main_Entrance_Gate_Day_Perspective.webp" },
    { src: "golden-villa/Bungalow_Main_Front_Elevation_Day.webp" },
    { src: "golden-villa/Community_Park_Aerial_Birdview.webp" },
    { src: "golden-villa/Residential_Layout_Birdview_Aerial.webp" },
  ],
  detail: {
    hero: {
      image: { src: "golden-villa/Bungalow_Main_Front_Elevation_Day.webp" },
    ...
    firstLook: {
      headline: "First Look",
      items: [
        { src: "golden-villa/Main_Entrance_Gate_Day_Perspective.webp", caption: "Main Entrance" },
        { src: "golden-villa/Bungalow_Main_Front_Elevation_Day.webp", caption: "Front Elevation" },
      ],
    },
    intro: {
    ...
    summary: {
      cards: [
        { src: "golden-villa/Main_Entrance_Gate_Day_Perspective.webp", metric: "Ankleshwar", label: "Location" },
        { src: "golden-villa/Bungalow_Main_Front_Elevation_Day.webp", metric: "2000 Sq.Ft.", label: "Built-up Area" },
        { src: "golden-villa/Community_Park_Aerial_Birdview.webp", metric: "4 BHK", label: "Bungalows" },
        { src: "golden-villa/Residential_Layout_Birdview_Aerial.webp", metric: "G + 2", label: "Floors" },
      ],
    },
    highlights: {
      headline: "Visual Highlights",
      items: [
        { src: "golden-villa/Community_Park_Aerial_Birdview.webp", caption: "Landscaped community parks & walkways" },
        { src: "golden-villa/Landscape_Zen_Garden_Buddha_Statue.webp", caption: "Zen garden & premium landscaping" },
        { src: "golden-villa/Landscape_Garden_Seating_Ground_View.webp", caption: "Resident seating & relaxation areas" },
        { src: "golden-villa/Residential_Layout_Birdview_Aerial.webp", caption: "4 BHK bungalows with an on-site shopping arcade" },
      ],
    },
    amenities: {
      headline: "Community Amenities",
      body: "Designed for owners who value space and privacy.",
      feature: { src: "golden-villa/Community_Park_Aerial_Birdview.webp" },
      items: AMENITIES_RESIDENTIAL,
    },
    floorPlans: {
      headline: "Floor Plans",
          ...
          plans: [
            {
              ...
              image: { src: "golden-villa/second_floor_plan.png" },
            },
          ],
        },
      ],
    ...
    gallery: {
      ...
      body: "A look at what awaits you.",
      images: [
        { src: "golden-villa/Bungalow_Full_Front_View_Daylight.webp" },
        { src: "golden-villa/Bungalow_Main_Front_Elevation_Night.webp" },
        { src: "golden-villa/Bungalow_Main_Front_Elevation_Night.webp" },
        { src: "golden-villa/Landscape_Zen_Garden_Buddha_Statue.webp" },
        { src: "golden-villa/Landscape_Garden_Seating_Ground_View.webp" },
        { src: "golden-villa/Community_Park_Aerial_Birdview.webp" },
        { src: "golden-villa/Main_Entrance_Gate_Day_Perspective.webp" },
        { src: "golden-villa/Residential_Layout_Birdview_Aerial.webp" },
      ],
...
const goldenHomes: Project = {
  ...
  status: "Completed",
  images: [
    { src: "golden-homes/Bungalow_Full_Front_View_Day.webp" },
    { src: "golden-homes/Bungalow_Entrance_Parking_View.webp" },
    { src: "golden-homes/Bungalow_Side_Elevation_Landscaping.webp" },
    { src: "golden-homes/Residential_Layout_Birdview_Aerial.webp" },
  ],
  detail: {
    hero: {
      image: { src: "golden-homes/Bungalow_Full_Front_View_Day.webp" },
    ...
    firstLook: {
      headline: "First Look",
      items: [
        { src: "golden-homes/Bungalow_Entrance_Parking_View.webp", caption: "Main Entrance" },
        { src: "golden-homes/Bungalow_Full_Front_View_Day.webp", caption: "Front Elevation" },
      ],
    },
    intro: {
    ...
    summary: {
      cards: [
        { src: "golden-homes/Bungalow_Entrance_Parking_View.webp", metric: "Ankleshwar", label: "Location" },
        { src: "golden-homes/Bungalow_Full_Front_View_Day.webp", metric: "1029 Sq.Ft.", label: "Built-up Area" },
        { src: "golden-homes/Bungalow_Full_Front_View_Day.webp", metric: "3 BHK Villa", label: "Type" },
        { src: "golden-homes/Residential_Layout_Birdview_Aerial.webp", metric: "G + 1", label: "Floors" },
      ],
    },
    highlights: {
      headline: "Visual Highlights",
      items: [
        { src: "golden-homes/Bungalow_Side_Elevation_Landscaping.webp", caption: "Private garden & dedicated parking per home" },
        { src: "golden-homes/Community_Park_Area_Amenities.webp", caption: "Community park & open amenities" },
        { src: "golden-homes/Residential_Layout_Birdview_Aerial.webp", caption: "G+1 independent plotted bungalows" },
        { src: "golden-homes/Bungalow_Full_Front_View_Day.webp", caption: "3 BHK with Puja room & garden" },
      ],
    },
    amenities: {
      headline: "Community Amenities",
      body: "Quiet streets, generous green pockets, and space to make your own.",
      feature: { src: "golden-homes/Community_Park_Area_Amenities.webp" },
      items: AMENITIES_RESIDENTIAL,
    },
    floorPlans: {
      headline: "Floor Plans",
    ...
    gallery: {
      ...
      body: "A look at what awaits you.",
      images: [
        { src: "golden-homes/Bungalow_Full_Front_View_Night.webp" },
        { src: "golden-homes/Bungalow_Internal_Road_Perspective.webp" },
        { src: "golden-homes/Bungalow_Side_Elevation_Landscaping.webp" },
        { src: "golden-homes/Bungalow_Entrance_Parking_View.webp" },
        { src: "golden-homes/Community_Park_Area_Amenities.webp" },
        { src: "golden-homes/Residential_Layout_Birdview_Aerial.webp" },
      ],
    },
    masterPlan: {
...
const goldenPalmVilla: Project = {
  ...
  status: "Completed",
  images: [
    { src: "golden-palm-villa/Bungalow_Street_Level_Day_View.webp" },
    { src: "golden-palm-villa/Bungalow_Street_Landscape_Night_Perspective.webp" },
    { src: "golden-palm-villa/Community_Park_And_Landscaping_Aerial.webp" },
    { src: "golden-palm-villa/Landscape_Garden_Gazebo_and_Waterpond.webp" },
  ],
  detail: {
    hero: {
      image: { src: "golden-palm-villa/Bungalow_Street_Landscape_Night_Perspective.webp" },
    ...
    firstLook: {
      headline: "First Look",
      items: [
        { src: "golden-palm-villa/Bungalow_Street_Level_Day_View.webp", caption: "Main Entrance Approach" },
        { src: "golden-palm-villa/Bungalow_Street_Landscape_Night_Perspective.webp", caption: "Front Elevation" },
      ],
    },
    intro: {
    ...
    summary: {
      cards: [
        { src: "golden-palm-villa/Bungalow_Street_Level_Day_View.webp", metric: "Ankleshwar", label: "Location" },
        { src: "golden-palm-villa/Bungalow_Street_Landscape_Night_Perspective.webp", metric: "74 Homes", label: "Community" },
        { src: "golden-palm-villa/Community_Park_And_Landscaping_Aerial.webp", metric: "3 BHK", label: "Bungalow" },
        { src: "golden-palm-villa/Landscape_Garden_Gazebo_and_Waterpond.webp", metric: "Club House", label: "Amenities" },
      ],
    },
    highlights: {
      headline: "Visual Highlights",
      items: [
        { src: "golden-palm-villa/Community_Park_And_Landscaping_Aerial.webp", caption: "74 private bungalow homes" },
        { src: "golden-palm-villa/Landscape_Garden_Gazebo_and_Waterpond.webp", caption: "Garden gazebo & water pond" },
        { src: "golden-palm-villa/Bungalow_Street_Level_Day_View.webp", caption: "3 BHK with individual plot & garden" },
        { src: "golden-palm-villa/Bungalow_Street_Landscape_Night_Perspective.webp", caption: "Club house & premium amenities" },
      ],
    },
    amenities: {
      headline: "Community Amenities",
      body: "Curated grounds, a clubhouse, and quiet streets to call your own.",
      feature: { src: "golden-palm-villa/Landscape_Garden_Gazebo_and_Waterpond.webp" },
      items: [
...
const goldenResidency: Project = {
  ...
  status: "Completed",
  images: [
    { src: "golden-residency/Building_Side_Elevation_Daylight.webp" },
    { src: "golden-residency/Building_Full_Front_Elevation_Day.webp" },
    { src: "golden-residency/Residential_Complex_Birdview_Aerial.webp" },
  ],
  detail: {
    hero: {
      image: { src: "golden-residency/Building_Full_Front_Elevation_Day.webp" },
    ...
    firstLook: {
      headline: "First Look",
      items: [
        { src: "golden-residency/Building_Side_Elevation_Daylight.webp", caption: "Main Entrance Approach" },
        { src: "golden-residency/Building_Full_Front_Elevation_Day.webp", caption: "Front Elevation" },
      ],
    },
    intro: {
    ...
    summary: {
      cards: [
        { src: "golden-residency/Building_Side_Elevation_Daylight.webp", metric: "Tavra, Bharuch", label: "Location" },
        { src: "golden-residency/Building_Full_Front_Elevation_Day.webp", metric: "500 - 671 Sq.Ft.", label: "Carpet Area" },
        { src: "golden-residency/Residential_Complex_Birdview_Aerial.webp", metric: "1 & 2 BHK", label: "Type" },
        { src: "golden-residency/Building_Side_Elevation_Daylight.webp", metric: "8 Wings", label: "A - H Blocks" },
      ],
    },
    highlights: {
      headline: "Visual Highlights",
      items: [
        { src: "golden-residency/Residential_Complex_Birdview_Aerial.webp", caption: "Multi-block gated complex" },
    ...
    amenities: {
      ...
      feature: { src: "golden-residency/Building_Side_Elevation_Daylight.webp" },
      items: AMENITIES_RESIDENTIAL,
    },
    floorPlans: {
      headline: "Floor Plans",
          ...
          plans: [
            {
              ...
              image: { src: "golden-residency/typical_floor_plan_2bhk_wing_abcdg-h.png" },
            },
          ],
        },
        {
          ...
          plans: [
            {
              ...
              image: { src: "golden-residency/project_1bhk_typical_floor_plan.png" },
            },
          ],
        },
      ],
...
const goldenSquareBharuch: Project = {
  ...
  status: "Completed",
  images: [
    { src: "golden-square-bharuch/Building_Front_Daylight_Full_Elevation.webp" },
    { src: "golden-square-bharuch/Entrance_Parking_Ramp_Close_up.webp" },
    { src: "golden-square-bharuch/Interior_Atrium_Mall_View.webp" },
    { src: "golden-square-bharuch/Cinemas entry-01.webp" },
  ],
  detail: {
    hero: {
      image: { src: "golden-square-bharuch/Building_Front_Daylight_Full_Elevation.webp" },
    ...
    firstLook: {
      headline: "First Look",
      items: [
        { src: "golden-square-bharuch/Entrance_Parking_Ramp_Close_up.webp", caption: "Main Entrance & Ramp" },
        { src: "golden-square-bharuch/Building_Front_Daylight_Full_Elevation.webp", caption: "Front Elevation" },
      ],
    },
    intro: {
    ...
    summary: {
      cards: [
        { src: "golden-square-bharuch/Building_Front_Daylight_Full_Elevation.webp", metric: "Bharuch", label: "Location" },
        { src: "golden-square-bharuch/Entrance_Parking_Ramp_Close_up.webp", metric: "252 Units", label: "150 Shops + 102 Offices" },
        { src: "golden-square-bharuch/Interior_Atrium_Mall_View.webp", metric: "G + 9", label: "Floors" },
        { src: "golden-square-bharuch/Cinemas entry-01.webp", metric: "Mall + Cinema", label: "Mix Use" },
      ],
    },
    highlights: {
      headline: "Visual Highlights",
      items: [
        { src: "golden-square-bharuch/Interior_Atrium_Mall_View.webp", caption: "Grand Interior Atrium" },
        { src: "golden-square-bharuch/Cinemas entry-01.webp", caption: "Luxury Cinema Entry" },
        { src: "golden-square-bharuch/Food court-04.webp", caption: "Premium Food Court Area" },
        { src: "golden-square-bharuch/Exterior_Walkway_Ivy_Lights.webp", caption: "Landscaped Walkways" },
      ],
    },
    amenities: {
      headline: "Building Amenities",
      body: "From triple-height atrium to dedicated cinema and food court - designed for footfall.",
      feature: { src: "golden-square-bharuch/Interior_Atrium_Mall_View.webp" },
      items: AMENITIES_COMMERCIAL,
    },
    floorPlans: {
      headline: "Project Layouts",
          ...
          plans: [
            {
              ...
              image: { src: "golden-square-bharuch/second_floor.png" },
            },
          ],
        },
        {
    ...
    gallery: {
      ...
      body: "A look at the building.",
      images: [
        { src: "golden-square-bharuch/Building_Street_Perspective_View.webp" },
        { src: "golden-square-bharuch/Entrance Foyer-Final.webp" },
        { src: "golden-square-bharuch/Theater lobby-06.webp" },
        { src: "golden-square-bharuch/Passage.webp" },
        { src: "golden-square-bharuch/new Cam_09.webp" },
        { src: "golden-square-bharuch/Food court-04.webp" },
        { src: "golden-square-bharuch/Cinemas entry-01.webp" },
        { src: "golden-square-bharuch/Exterior_Walkway_Ivy_Lights.webp" },
      ],
    },
    pillars: { items: PILLARS_DEFAULT },
  },
