...
const SLOTS: Record<FolderKey, SlotMap> = {
  ...
  GoldenPalmVilla: {
    ...
    "4": "Clubhouse_Exterior_Day.webp",
  },
  GoldenResidency: {
    "0": "Building_Full_Front_Elevation_Day.webp",
    "1": "Building_Central_Tower_Twilight.webp",
    "2": "Main_Entrance_Gate_Retail_Day.webp",
    "3": "Building_Side_Elevation_Daylight.webp",
    "4": "Landscape_Courtyard_Garden_Twilight.webp",
    "5": "Courtyard_Garden_Aerial_Night.webp",
    "6": "Interior_Entrance_Lobby_Reception.webp",
    "7": "Interior_Fitness_Gym.webp",
    "8": "Interior_Indoor_Games_Room.webp",
    "9": "Interior_Banquet_Hall.webp",
    "10": "Children_Play_Area.webp",
    "11": "Residential_Complex_Birdview_Aerial.webp",
  },
  GoldenSquareAnkleshwar: {
...
const HIDDEN: Record<FolderKey, HiddenMap> = {
  ...
  GoldenHomes: {},
  GoldenNirvana: {},
  GoldenPalmPlaza: { amenities: true },
  GoldenPalmVilla: { amenities: true },
  GoldenResidency: { amenities: true },
  GoldenSquareAnkleshwar: {},
  GoldenSquareBharuch: {},
  GoldenVilla: {},
};
